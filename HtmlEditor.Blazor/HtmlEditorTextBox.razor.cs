...
namespace HtmlEditor.Blazor
{
    ...
    /// <example>
    /// <code>
    /// &lt;HtmlEditorTextBox @bind-Value=@value Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class HtmlEditorTextBox : FormComponent<string>
    {
        /// <summary>
        ...
        {
            return GetClassList("html-editor-textbox").ToString();
        }
    }
}
