...
{
    /// <summary>
    /// HtmlEditorColorPicker component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;HtmlEditorColorPicker @bind-Value=@color Change=@(args => Console.WriteLine($"Selected color: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class HtmlEditorColorPicker : FormComponent<string>
    {
        /// <summary>
        ...
        {
            var classList = new List<string>() { "html-editor-colorpicker-toolbar" };
