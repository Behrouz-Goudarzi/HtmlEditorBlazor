...
{
    /// <summary>
    /// HtmlEditorNumeric component.
    /// </summary>
    /// <typeparam name="TValue">The type of the t value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;HtmlEditorNumeric TValue="int" Min="1" Max="10" Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class HtmlEditorNumeric<TValue> : FormComponent<TValue>
    {
        /// <summary>
        ...
        {
            return GetClassList("html-editor-spinner").ToString();
        }
        ...
        private string getOnInput()
        {
            ...
            return Min != null || Max != null ? $@"HtmlEditor.numericOnInput(event, {minArg ?? "null"}, {maxArg ?? "null"})" : "";
        }
        ...
        private string getOnPaste()
        {
            ...
            return Min != null || Max != null ? $@"HtmlEditor.numericOnPaste(event, {minArg ?? "null"}, {maxArg ?? "null"})" : "";
        }
        ...
        private async System.Threading.Tasks.Task InternalValueChanged(object value)
        {
            ...
            {
                await JSRuntime.InvokeAsync<string>("HtmlEditor.setInputValue", input, FormattedValue);
                return;
            }
